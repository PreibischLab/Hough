package varun;
	...
	import Jama.Matrix;
	public class LevenbergMarquardtSolverMT {
		/**
		...
		public static final int solve(
				...
				int maxiter,
				final double slope,
				final double intercept) throws Exception  {
			int npts = y.length;
			int nparm = a.length;
		
			double e0 = chiSquared(x, a, y, f, slope, intercept);
			boolean done = false;
			...
			do {
				...
				double e1 = chiSquared(x, na, y, f, slope, intercept);
