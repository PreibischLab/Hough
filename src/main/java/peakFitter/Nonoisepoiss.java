...
public class Nonoisepoiss implements FitFunction {
	...
	//@ degree = 0 is the probability of seeing no noise at the chosen point if the probability is higher than SNR then the 
	// chosen pixel is non-noisy else it is taken as noise at the pixel and the pixel is removed.
